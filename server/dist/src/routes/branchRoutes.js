...
export function createBranchRouter(repository) {
    const router = Router();
    const auditService = new AuditService();
    router.get('/', requirePermissions(['settings.branches.read']), asyncHandler(async (req, res) => {
    ...
    router.post('/', requirePermissions(['settings.branches.write']), asyncHandler(async (req, res) => {
        const companyId = requireCompanyId(req);
    ...
    router.put('/:id', requirePermissions(['settings.branches.write']), asyncHandler(async (req, res) => {
        const companyId = requireCompanyId(req);
    ...
    router.delete('/:id', requirePermissions(['settings.branches.write']), asyncHandler(async (req, res) => {
        const companyId = requireCompanyId(req);
