...
export async function renderHtmlToPdfBuffer(html, landscape = true) {
    ...
    const executablePath = process.env.PUPPETEER_EXECUTABLE_PATH?.trim() ||
        ...
        (process.platform === 'win32'
            ...
            : undefined);
    if (!executablePath) {
        throw new HttpError(503, 'لم يُعثر على متصفح Chromium/Chrome للتصدير — عيّن PUPPETEER_EXECUTABLE_PATH على الخادم.');
    }
