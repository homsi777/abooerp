...
export function createTransfersRouter(transfersService) {
    const router = Router();
    ...
    router.post('/:id/complete', requirePermissions(['transfers.write']), requireIdempotencyKey('transfers.complete'), asyncHandler(async (req, res) => {
        const scope = parseDataScope(req);
        ...
        const baseCurrency = req.requestUserContext?.baseCurrency;
    ...
    router.post('/:id/cancel', requirePermissions(['transfers.write']), requireIdempotencyKey('transfers.cancel'), asyncHandler(async (req, res) => {
        const scope = parseDataScope(req);
