...
function canBackdateVouchers(req) {
    const userContext = req.requestUserContext;
...
function resolveVoucherTargetDate(createdAt) {
    if (createdAt)
        return createdAt.slice(0, 10);
    return todayIsoDate();
}
function assertVoucherDateAllowed(req, targetDate) {
...
function voucherFxContext(req, createdAt) {
    const userContext = req.requestUserContext;
    return {
...
export function createFinanceRouter(service) {
    ...
    router.get('/receipt-vouchers', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.read', 'finance.vouchers.view']), asyncHandler(async (req, res) => {
    ...
    router.get('/receipt-vouchers/:id', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.read', 'finance.vouchers.view']), asyncHandler(async (req, res) => {
    ...
    router.post('/receipt-vouchers', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.create', 'finance.vouchers.write']), licenseGuard('receipt'), requireIdempotencyKey('finance.receipt.create'), asyncHandler(async (req, res) => {
        try {
            ...
            emit({ type: 'voucher.created', companyId: req.requestUserContext?.companyId ?? '', entityId: row.id, timestamp: new Date().toISOString(), correlationId: req.correlationId });
    ...
    router.put('/receipt-vouchers/:id', forbidUserTypes(['agent'], 'لا تملك صلاحية تعديل هذا السند.'), requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.update', 'finance.vouchers.write']), requireIdempotencyKey('finance.receipt.update'), asyncHandler(async (req, res) => {
        try {
    ...
    router.post('/receipt-vouchers/auto-generate-from-delivery/:deliveryId', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.create', 'finance.vouchers.write']), requireIdempotencyKey('finance.receipt.auto-generate'), asyncHandler(async (req, res) => {
        try {
    ...
    router.get('/payment-vouchers', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.read', 'finance.vouchers.view']), asyncHandler(async (req, res) => {
        const rows = await service.listPaymentVouchers(parseDataScope(req));
        res.json({ success: true, data: rows });
    }));
    router.get('/payment-vouchers/:id', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.read', 'finance.vouchers.view']), asyncHandler(async (req, res) => {
    ...
    router.post('/payment-vouchers', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.create', 'finance.vouchers.write']), requireIdempotencyKey('finance.payment.create'), asyncHandler(async (req, res) => {
        try {
    ...
    router.put('/payment-vouchers/:id', forbidUserTypes(['agent'], 'لا تملك صلاحية تعديل هذا السند.'), requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.vouchers.update', 'finance.vouchers.write']), requireIdempotencyKey('finance.payment.update'), asyncHandler(async (req, res) => {
        try {
    ...
    router.get('/cashboxes', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.cashboxes.view', 'finance.cashbox.read']), asyncHandler(async (req, res) => {
    ...
    router.post('/cashboxes/sync', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requirePermissions(['finance.cashboxes.manage']), asyncHandler(async (req, res) => {
    ...
    router.get('/cashboxes/:id', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.cashboxes.view', 'finance.cashbox.read']), asyncHandler(async (req, res) => {
    ...
    router.get('/cashboxes/:id/movements', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.cashboxes.movements.view', 'finance.cashbox.read']), asyncHandler(async (req, res) => {
        const rows = await service.listCashboxMovementsForCashbox(String(req.params.id), parseDataScope(req));
        res.json({ success: true, data: rows });
    }));
    router.get('/cashboxes/:id/statement', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.cashboxes.movements.view', 'finance.cashbox.read']), asyncHandler(async (req, res) => {
    ...
    router.post('/cashboxes', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requirePermissions(['finance.cashboxes.manage']), forbidUserTypes(['agent'], 'إنشاء صناديق جديدة متاح للإدارة فقط.'), asyncHandler(async (req, res) => {
    ...
    router.put('/cashboxes/:id', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requirePermissions(['finance.cashboxes.manage']), forbidUserTypes(['agent'], 'تعديل تعريف الصندوق متاح للإدارة فقط.'), asyncHandler(async (req, res) => {
    ...
    router.get('/cashbox-transactions', requireAnyPermissions(['finance.read', 'finance.write', 'finance.view']), requireAnyPermissions(['finance.cashboxes.movements.view', 'finance.cashbox.read']), asyncHandler(async (req, res) => {
        const rows = await service.listCashboxTransactions(parseDataScope(req));
        res.json({ success: true, data: rows });
    }));
    router.get('/party-financial-movements', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'هذا التقرير غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const rows = await service.listPartyFinancialMovements(parseDataScope(req));
        res.json({ success: true, data: rows });
    }));
    router.get('/debit-credit-summary', requireAnyPermissions(['finance.debit_credit.view', 'finance.read', 'finance.view']), forbidUserTypes(['agent'], 'مركز الدائن والمدين غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/reports/trial-balance', requireAnyPermissions(['finance.read', 'finance.view']), forbidUserTypes(['agent'], 'ميزان المراجعة غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/reports/balance-sheet', requireAnyPermissions(['finance.read', 'finance.view']), forbidUserTypes(['agent'], 'قائمة المركز المالي غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const query = accountingReportQuerySchema.parse(req.query);
        const data = await service.getBalanceSheetReport(parseDataScope(req), query);
        res.json({ success: true, data });
    }));
    router.get('/accounting-periods', requireAnyPermissions(['finance.read', 'finance.view']), forbidUserTypes(['agent'], 'إقفال الفترات غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const limit = Math.min(100, Math.max(1, Number(req.query.limit ?? 50)));
        const data = await service.listAccountingPeriodClosures(parseDataScope(req), limit);
        res.json({ success: true, data });
    }));
    router.post('/accounting-periods/close', requireAnyPermissions(['finance.write', 'finance.read']), forbidUserTypes(['agent'], 'إقفال الفترات غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/agent-settlement', requireAnyPermissions(['finance.read', 'finance.view']), forbidUserTypes(['agent'], 'كشف تسوية الوكيل غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/hawala-reconciliation', requireAnyPermissions(['finance.read', 'finance.view']), forbidUserTypes(['agent'], 'مطابقة الحوالات غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const query = agentReconciliationQuerySchema.parse(req.query);
        const companyId = requireCompanyId(req);
    ...
    router.get('/agent-branch-reconciliation', requireAnyPermissions(['finance.read', 'finance.view']), forbidUserTypes(['agent'], 'مطابقة الوكيل والفرع الرئيسي غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const query = agentReconciliationQuerySchema.parse(req.query);
        const companyId = requireCompanyId(req);
    ...
    router.get('/financial-reports/profit-loss', requireAnyPermissions(['finance.read', 'finance.view']), forbidUserTypes(['agent'], 'تقرير الأرباح والخسائر غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/account-statement', requireAnyPermissions(['finance.account_statement.view', 'finance.read', 'finance.view']), forbidUserTypes(['agent'], 'كشف الحساب التفصيلي غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/party-statements/summary', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/party-statements/entries', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const query = partyStatementQuerySchema.parse(req.query);
        const rows = await service.listPartyStatementEntries(parseDataScope(req), query);
        res.json({ success: true, data: rows });
    }));
    router.get('/party-statements/ledger', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/party-statements/currency-summary', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const query = partyStatementQuerySchema.parse(req.query);
        const result = await service.getPartyCurrencySummary(parseDataScope(req), query);
        res.json({ success: true, data: result });
    }));
    router.get('/party-statements/package', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const query = partyLedgerQuerySchema.parse(req.query);
        const result = await service.getPartyStatementPackage(parseDataScope(req), query);
        res.json({ success: true, data: result });
    }));
    router.get('/party-statements/compare', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/party-statements/analytics', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/party-statements/dashboard-package', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/party-statements/dashboard-cache-metrics', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (_req, res) => {
        const result = await service.getDashboardCacheMetrics();
        res.json({ success: true, data: result });
    }));
    router.post('/party-statements/dashboard-cache-reset', requirePermissions(['finance.write', 'finance.vouchers.write']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
    ...
    router.get('/party-statements/dashboard-cache-reset-audit', requirePermissions(['finance.read', 'finance.vouchers.read']), forbidUserTypes(['agent'], 'تقارير الأطراف غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const limit = typeof req.query.limit === 'string' ? Number(req.query.limit) : 20;
        const result = await service.getDashboardCacheResetAudit(Number.isFinite(limit) ? limit : 20);
        res.json({ success: true, data: result });
    }));
    // ── Agent COD Statement ───────────────────────────────────────────────────────
    router.get('/agent-cod-statement', requirePermissions(['finance.read', 'shipments.read']), asyncHandler(async (req, res) => {
        const { pool } = await import('../db/pool.js');
        const scope = parseDataScope(req);
        const uc = req.requestUserContext;
        const q = req.query;
        ...
        if (forcedAgentId || q.agentId) {
            ...
            const receiptValues = [];
            const receiptConditions = [`rv.status = 'confirmed'`];
            if (scope.companyId) {
    ...
    router.get('/delivery-reports/pending-transfers', requirePermissions(['finance.read', 'transfers.read']), forbidUserTypes(['agent'], 'التقارير غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const { pool } = await import('../db/pool.js');
        const scope = parseDataScope(req);
        ...
        const conditions = [`t.company_id = $1::uuid`, `t.status = 'PENDING'`];
        if (q.branchId) {
            values.push(q.branchId);
    ...
    router.get('/delivery-reports/transfer-profit', requirePermissions(['finance.read', 'transfers.read']), forbidUserTypes(['agent'], 'التقارير غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const { pool } = await import('../db/pool.js');
        const scope = parseDataScope(req);
        const q = deliveryReportQuerySchema.parse(req.query);
        if (!scope.companyId) {
    ...
    router.get('/delivery-reports/legacy-additional-charges', requirePermissions(['finance.read', 'shipments.read']), forbidUserTypes(['agent'], 'التقارير غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const { pool } = await import('../db/pool.js');
        const scope = parseDataScope(req);
        const q = deliveryReportQuerySchema.parse(req.query);
        if (!scope.companyId) {
    ...
    router.get('/delivery-reports/agent-commission-review', requirePermissions(['finance.read', 'shipments.read']), forbidUserTypes(['agent'], 'التقارير غير متاحة لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const { pool } = await import('../db/pool.js');
        const scope = parseDataScope(req);
        const q = deliveryReportQuerySchema.parse(req.query);
        if (!scope.companyId) {
    ...
    router.get('/diagnostics/sender-receiver-movements', requirePermissions(['finance.read']), forbidUserTypes(['agent'], 'التشخيص غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const { pool } = await import('../db/pool.js');
        const scope = parseDataScope(req);
        ...
        const listRes = await pool.query(`select s.shipment_no, s.id as shipment_id, pfm.id as movement_id,
    ...
    router.get('/diagnostics/shipment-breakdown', requirePermissions(['finance.read']), forbidUserTypes(['agent'], 'التشخيص المالي غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const { pool } = await import('../db/pool.js');
        const scope = parseDataScope(req);
        const values = [];
        const conditions = [
    ...
    router.post('/repair/shipment-breakdown/:shipmentId', requirePermissions(['finance.write']), forbidUserTypes(['agent'], 'إصلاح القيود المالية غير متاح لمستخدم الوكيل.'), asyncHandler(async (req, res) => {
        const { pool } = await import('../db/pool.js');
        const scope = parseDataScope(req);
          ...
          `, [shipmentId]);
            ...
            if (partyType && partyId) {
              ...
              `, [
                        ...
                        req.requestUserContext?.userId ?? null,
