...
async function runPhase312CacheControlSmoke() {
    ...
    try {
        ...
        const metricsBeforeReset = await request(baseUrl, '/api/v1/party-statements/dashboard-cache-metrics', { auth: { userId: adminUserId } });
        ...
        const metricsAfterResetRead = await request(baseUrl, '/api/v1/party-statements/dashboard-cache-metrics', { auth: { userId: adminUserId } });
