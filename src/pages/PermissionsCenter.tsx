...
const roleTemplates: PermissionTemplate[] = [
  ...
  },
  {
    ...
    roleCode: 'accountant',
    userType: 'accountant',
    description: 'المالية والسندات (بما فيها التاريخ السابق) والوكلاء (عرض) والتقارير وإدارة العملاء الحسابيين.',
    modules: ['المالية', 'السندات', 'الصناديق', 'الدائن والمدين', 'كشف الحساب', 'التقارير المالية', 'العملاء', 'الوكلاء'],
    permissionCodes: [
