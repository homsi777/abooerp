            ...
            <div className="flex items-center justify-between border-b p-4 gap-2 flex-wrap">
              ...
              <div className="flex gap-2 flex-wrap">
                <FinancialStatementPrintButtons
                  ...
                  pdfTitle={statement.title}
                  pdfFileName={`agent-statement-${statement.kind}-${new Date().toISOString().split('T')[0]}.pdf`}
                  onBuildHtml={() => buildAgentStatementPrintHtml(statement.kind, statement.data, statement.title)}
                />
