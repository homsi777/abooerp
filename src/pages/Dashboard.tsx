    ...
    <div className="db-root" dir="rtl">
      ...
      <section className="db-card">
        ...
        <div className="db-quick-actions">
          ...
          {canViewFinance && <QuickAction to="/finance/bilateral-reconciliation" icon={<Users size={18} />} label="مطابقة ثنائية" sub="وكيل ↔ فرع — اعتماد الذمة" />}
          {canViewFinance && <QuickAction to="/finance/statements/reconciliation/agent-branch" icon={<FileText size={18} />} label="كشف وكيل ↔ فرع" sub="تقرير شحن + حوالات" />}
