    ...
    <div className="h-full flex flex-col">
      <div className="mb-3">
        ...
        <p className="text-sm text-gray-600">
          أرصدة الوكلاء والعملاء الحسابيين — تُبنى تلقائياً من <strong>حفظ دفتر الشحن اليومي</strong> (ترحيل الشحنات)،
          من أول تاريخ إدخال. لا حاجة لفتح الصناديق أو السندات لرؤية الذمم. السندات لاحقاً لتسجيل التحصيل النقدي فقط.
        </p>
      </div>
