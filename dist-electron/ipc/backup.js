...
export function registerBackupIpc() {
    ...
    ipcMain.handle(CHANNEL_BACKUP_SELECT_SAVE, async (_event, payload) => {
    ...
    ipcMain.handle(CHANNEL_BACKUP_COPY_FILE, async (_event, payload) => {
    ...
    ipcMain.handle(CHANNEL_BACKUP_DOWNLOAD_TO_PATH, async (_event, payload) => {
    ...
    ipcMain.handle(CHANNEL_BACKUP_WRITE_FILE, async (_event, payload) => {
        const destPath = payload?.destPath?.trim();
